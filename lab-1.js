...
class Point3D extends Point2D {
  ...
  static areCollinear(a, b, c) {
    ...
    // 1 a.y b.y
    const det1 =
      a.y * b.z + a.z * b.x + a.x * b.y - b.x * a.y - b.y * a.z - a.x * b.z;
    ...
    // 1 a.y c.y
    const det2 =
      a.y * c.z + a.z * c.x + a.x * c.y - c.x * a.y - c.y * a.z - a.x * c.z;
    ...
    // 1 b.y c.y
    const det3 =
      b.y * c.z + b.z * c.x + b.x * c.y - c.x * b.y - c.y * b.z - b.x * c.z;
...
console.log(
  Point2D.areCollinear(new Point2D(1, 1), new Point2D(1, 4), new Point2D(1, 3))
);

console.log(
  Point2D.areCollinear(new Point2D(1, 1), new Point2D(2, 5), new Point2D(4, 6))
);

console.log(
  Point3D.areCollinear(
    new Point3D(6, 7, 1),
    new Point3D(2, -3, 1),
    new Point3D(4, -5, 0)
  )
